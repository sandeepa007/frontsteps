 ...
 */
class home_feature_Widget_citrus extends WP_Widget {
...
// Register the widget.
function home_register_home_features_widget_citrus() { 
  register_widget( 'home_feature_Widget_citrus' );
}
add_action( 'widgets_init', 'home_register_home_features_widget_citrus', 20 );

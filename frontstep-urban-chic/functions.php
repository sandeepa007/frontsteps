...
add_action('customize_register', 'urbunchick_customize_register', 1000);
function urbunchick_customize_register($wp_customize) {
...
function customizer_library_urbun_options($wp_customize) {
    $options = array();
    $sections = array();
    $panels = array();
...
add_action( 'init', 'customizer_library_urbun_options', 15 );
/**

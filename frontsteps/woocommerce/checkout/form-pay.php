	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'frontsteps' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'frontsteps' ); ?></th>
			</tr>
		</thead>
		<tbody>

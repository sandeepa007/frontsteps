        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="stat-block text-center">
                    <h3 class="h3 color-dark"><?php echo get_theme_mod( 'about-section1-title' ); ?></h3>
                    <p><?php echo get_theme_mod( 'about-section1-desc' ); ?></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <div class="stat-block text-center">
                    <h3 class="h3 color-dark"><?php echo get_theme_mod( 'about-section2-title' ); ?></h3>
                    <p><?php echo get_theme_mod( 'about-section2-desc' ); ?></p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
                <div class="stat-block text-center">
                    <h3 class="h3 color-dark"><?php echo get_theme_mod( 'about-section3-title' ); ?></h3>

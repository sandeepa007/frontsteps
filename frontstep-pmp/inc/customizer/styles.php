 ...
 */
if (!function_exists('customizer_library_demo_build_styles_bbd')) :
     ...
     * @return void
     */
    function customizer_library_demo_build_styles_bbd()
    {
        ...
        if ($mod !== customizer_library_get_default($setting)) {
            ...
            Customizer_Library_Styles()->add(array(
                'selectors' => array(
                    ...
                    '.page-template-page-templatescontact-page-php .bg-image.fill'
                ),
                'declarations' => array(
...
add_action('customizer_library_styles_bbd', 'customizer_library_demo_build_styles_bbd');

if (!function_exists('customizer_library_demo_styles_bbd')) :
    /**
     ...
     * @return void
     */
    function customizer_library_demo_styles_bbd()
    {

        do_action('customizer_library_styles_bbd');
...
add_action('wp_head', 'customizer_library_demo_styles_bbd', 20);
